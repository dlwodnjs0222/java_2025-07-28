...
public class OrderWin2 extends JFrame {
	...
	Order01[] orders = new Order01[] {
            new Order01("ORD001", "Notebook", 2),
            new Order01("ORD002", "Mouse", 10),
            new Order01("ORD003", "Keyboard", 5)
        };
	int index = 0;
	public OrderWin2() {
		...
		btn1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				orders[index++] = new Order01(orderId, product, quantity);
				tf1.setText("");
				tf2.setText("");
				tf3.setText("");
		...
		btn2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream("c:/tmp/orders.dat"))) {
		            Order01[] orders = (Order01[]) ois.readObject();
//		            System.out.println("파일에서 주문 배열을 읽어왔습니다:");
		            String s = "";
		            for (Order01 o : orders) {
