	...
	public Quiz02() {
		...
		btn1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				ord = new Order01(orderId, product, quantity);
				tf1.setText("");
				tf2.setText("");
				tf3.setText("");
		...
		btn2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream("c:/tmp/order.dat"))) {
		            ord = (Order01) ois.readObject();
		            tf1.setText(ord.getOrderId());
		            tf2.setText(ord.getProduct());
		            tf3.setText(String.valueOf(ord.getQuantity()));
